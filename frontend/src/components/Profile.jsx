...
//   const [tourDataMap, setTourDataMap] = useState({}); // Changed to an object to store tour data for each booking
...
//             {/* Booking Details Section remains the same */}
...
//               {data.all_payments.map((payment, paymentIndex) => {
...
//                         <p className="font-semibold">#{payment.bill_id}</p>
//                       </div>
//                       <div>
...
//                                 <p className="font-semibold">{tourData.time}</p>
//                               </div>
//                             </div>
//                           </div>
//                         )}
                ...
                <div className="space-y-4">
                  {data.all_payments.map((payment, paymentIndex) => (
                    payment.type === "Booking" && (
                      <div key={paymentIndex} className="p-4 rounded-lg bg-blue-50">
                        <div className="grid grid-cols-3 gap-4">
                          <div>
                            <p className="text-gray-600">Bill ID</p>
                            <p className="font-semibold">#{payment.bill_id}</p>
